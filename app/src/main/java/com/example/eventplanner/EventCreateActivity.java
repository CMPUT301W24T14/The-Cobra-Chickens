...
public class EventCreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventCreateButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                event_name = String.valueOf(editTextEventName);
                event_max_attendees = String.valueOf(editTextMaxAttendees);
                Map<String, Object> doc_event = new HashMap<>();
                doc_event.put("Name", event_name);
                doc_event.put("Max Attendees", event_max_attendees);
                ...
                db.collection("events").document()
                        .set(doc_event);
                //Intent intent = new Intent(getApplicationContext(), AllEventsFragment.class);
                //startActivity(intent);
                //finish();
            }
        });
